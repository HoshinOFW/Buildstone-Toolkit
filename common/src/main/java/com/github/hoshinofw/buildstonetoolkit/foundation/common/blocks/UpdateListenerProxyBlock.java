...
public abstract class UpdateListenerProxyBlock extends RegisteredProxyBlock<UpdateListenerProxyBlockEntity>{
    ...
    private static final Map<ClientLevel, ProxyRegistry<UpdateListenerProxyBlockEntity>> clientRegistryMap = new Object2ObjectOpenHashMap<>();

    @Override
    @NotNull
    protected Map<ClientLevel, ProxyRegistry<UpdateListenerProxyBlockEntity>> getClientRegistryMap() {
