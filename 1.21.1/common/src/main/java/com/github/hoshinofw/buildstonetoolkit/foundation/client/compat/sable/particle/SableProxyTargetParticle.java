...
public class SableProxyTargetParticle {
    ...
    public record PosSupplier(Player player, long proxyId) implements Vec3Supplier {
        ...
        public Vec3 asVec3() {
            ...
            return SableCompanion.INSTANCE.projectOutOfSubLevel(player.level(), new Util.PositionImpl(pbe.getTargetPos().getCenter()));
        }
    }
    ...
    public static final class RenderTransform implements RenderTransformSupplier {
        ...
        private void resolve() {
            ...
            this.access = SableCompanion.INSTANCE.getContainingClient(targetPos);
            this.vec3 = targetPos.getCenter();
            this.valid = true;
        }
