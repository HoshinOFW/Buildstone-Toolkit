...
public class ObserverProxyBlockEntity extends UpdateListenerProxyBlockEntity<ObserverProxyBlock, ObserverProxyBlockEntity> {
    ...
    @Override
    public Class<ObserverProxyBlockEntity> selfClass() {
        return null;
    }

    @Override
    public ObserverProxyBlock getBlock() {
        return ObserverProxyBlock.getBlock();
    }
}
