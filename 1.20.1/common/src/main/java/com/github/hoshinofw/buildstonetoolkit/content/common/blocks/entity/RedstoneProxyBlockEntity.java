...
public class RedstoneProxyBlockEntity extends UpdateListenerProxyBlockEntity<RedstoneProxyBlock, RedstoneProxyBlockEntity> {
    ...
    public void setLinkedRelPos(long value) {
        ...
        if (level != null && !level.isClientSide() && RedstoneProxyBlock.getMode(getBlockState()) == RedstoneProxyBlock.PROXY_MODE.WRITE) {
